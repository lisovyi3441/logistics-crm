...
*   **Історія статусів:** Трекінг кожної зміни стану замовлення з відображенням часової стрічки (timeline).
*   **UI/UX:** Адаптивний інтерфейс на базі Radix Vue (доступні діалоги, випадаючі списки) та Tailwind CSS v4.
*   **Строга типізація:** Спеціалізовані класи-екшени (Actions) та сувора типізація (`declare(strict_types=1);`).
