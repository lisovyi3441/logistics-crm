    ...
    >
        ...
        >
            ...
            >
                ...
                >
                    <h1 class="mb-1 font-medium text-lg text-red-600 dark:text-red-400">Logistics CRM System</h1>
                    <p class="mb-4 text-[#706f6c] dark:text-[#A1A09A]">
                        Advanced Logistics Management platform <br />
                    </p>
                    <div class="mb-3 space-y-4">
                        <div class="p-3 bg-red-50 dark:bg-red-950/20 border border-red-100 dark:border-red-900/50 rounded-lg">
                            <p class="text-[12px] font-bold text-red-600 dark:text-red-400 mb-1 uppercase tracking-wider">Test Account</p>
